...
## Preface
I believe I created one of the most sophisticated and most used telegram bot in Singapore when I released it. Here's somme history of how it started.
...
{% include elements/figure.html image="/assets/projects/telegram_bot/app_1.jpeg" caption="" %}
{% include elements/figure.html image="/assets/projects/telegram_bot/app_2.jpeg" caption="" %}
{% include elements/figure.html image="/assets/projects/telegram_bot/app_3.jpeg" caption="" %}
{% include elements/figure.html image="/assets/projects/telegram_bot/app_4.jpeg" caption="" %}
{% include elements/figure.html image="/assets/projects/telegram_bot/app_5.jpeg" caption="" %}
{% include elements/figure.html image="/assets/projects/telegram_bot/app_6.jpeg" caption="" %}
{% include elements/figure.html image="/assets/projects/telegram_bot/app_7.jpeg" caption="" %}
{% include elements/figure.html image="/assets/projects/telegram_bot/app_1.gif" caption="" %}

{% include elements/button.html link="https://www.zaobao.com.sg/news/fukan/others/story20200726-1072028" text="Featured on Local News" %}
{% include elements/button.html link="https://dbcsingapore.org/scratchbacfinalistsspotlight2022/" text="Singapore Design Awards Winner 2022" %}
{% include elements/button.html link="https://www.zaobao.com.sg/news/fukan/others/story20200726-1072028" text="Press Coverage" %}
{% include elements/button.html link="https://www.kickstarter.com/projects/scratchbac/scratchbac-the-proximity-based-social-utility-app" text="Kickstarter" %}
{% include elements/button.html link="https://www.facebook.com/share/p/1EnMaRr4xu/" text="2020 China-ASEAN New Smart City Innovation & Entrepreneurship Competition Grand Champion" %}